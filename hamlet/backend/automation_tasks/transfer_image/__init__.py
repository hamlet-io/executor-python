...
class TransferImageAutomationRunner(AutomationRunner):
    ...
    def __init__(self, source_account, source_environment, deployment_unit, build_reference, image_format, **kwargs):
    ...
    def run(self):
        ...
        source_args = { **self._context_env, **{ 'account': self._source_account, 'environment': self._source_environment}}
