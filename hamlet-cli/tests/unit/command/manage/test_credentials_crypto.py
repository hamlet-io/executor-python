...
from hamlet.command.manage.credentials_crypto import credentials_crypto as manage_credentials_crypto
...
@mock.patch('hamlet.command.manage.credentials_crypto.manage_credentials_crypto_backend')
