...
from cot.command.create.buildblueprint import buildblueprint as create_buildblueprint
...
@mock.patch('cot.command.create.buildblueprint.create_buildblueprint_backend')
